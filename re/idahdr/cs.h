...
/* code signing attributes of a process */
	CS_VALID = 0x0000001,	/* dynamically valid */
	CS_ADHOC = 0x0000002,	/* ad hoc signed */
	CS_GET_TASK_ALLOW = 0x0000004,	/* has get-task-allow entitlement */
	CS_INSTALLER = 0x0000008,	/* has installer entitlement */

	CS_HARD = 0x0000100,	/* don't load invalid pages */
	CS_KILL = 0x0000200,	/* kill process if it becomes invalid */
	CS_CHECK_EXPIRATION = 0x0000400,	/* force expiration checking */
	CS_RESTRICT = 0x0000800,	/* tell dyld to treat restricted */
	CS_ENFORCEMENT = 0x0001000,	/* require enforcement */
	CS_REQUIRE_LV = 0x0002000,	/* require library validation */
	CS_ENTITLEMENTS_VALIDATED = 0x0004000,	/* code signature permits restricted entitlements */
	CS_NVRAM_UNRESTRICTED = 0x0008000,	/* has com.apple.rootless.restricted-nvram-variables.heritable entitlement */

#define	CS_ALLOWED_MACHO			 (CS_ADHOC | CS_HARD | CS_KILL | CS_CHECK_EXPIRATION | \
									  CS_RESTRICT | CS_ENFORCEMENT | CS_REQUIRE_LV)

	CS_EXEC_SET_HARD = 0x0100000,	/* set CS_HARD on any exec'ed process */
	CS_EXEC_SET_KILL = 0x0200000,	/* set CS_KILL on any exec'ed process */
	CS_EXEC_SET_ENFORCEMENT = 0x0400000,	/* set CS_ENFORCEMENT on any exec'ed process */
	CS_EXEC_INHERIT_SIP = 0x0800000,	/* set CS_INSTALLER on any exec'ed process */

	CS_KILLED = 0x1000000,	/* was killed by kernel for invalidity */
	CS_DYLD_PLATFORM = 0x2000000,	/* dyld used to load this is a platform binary */
	CS_PLATFORM_BINARY = 0x4000000,	/* this is a platform binary */
	CS_PLATFORM_PATH = 0x8000000,	/* platform binary by the fact of path (osx only) */
	...
	CS_DEV_CODE = 0x40000000,  /* code is dev signed, cannot be loaded into prod signed code (will go away with rdar://problem/28322552) */
	CS_DATAVAULT_CONTROLLER = 0x80000000,	/* has Data Vault controller entitlement */
